    ...
    <div class="container">
      <div class="row about">
        <div class="col-md-4">
          ...
          <p>
            The main focus this year will be on: azure, office 365 and dynamics365 but there will
        ...
        <div class="col-md-4">
          ...
          <p>
            <span>Three nights in single bedroom at onsite hotel</span>
          </p>
          <p>
            <span>Breakfast friday, saturday and sunday</span>
          </p>
          <p>
            <span>Lunch, coffee and small treats for the full duration</span>
          </p>
          <p>
            <span>Geekfood thursday, dinner friday and banquet dinner saturday</span>
          </p>
          <p>
            <span>Subsidized cloudpints (beer)</span>
          </p>
          <h4>Values and wins</h4>
          <p><span>ACDC is a community event (affordable and inclusive)</span></p>
          <P><span>ACDC is </span>non-profit (all money goes into the events)</p>
          <P><span>ACDC is about learning, sharing and fun (be nice)</span></p>
